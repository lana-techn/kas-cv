...
// Penanganan form untuk Aksi Tambah dan Hapus
if ($_SERVER['REQUEST_METHOD'] === 'POST' && isset($_POST['action'])) {
    try {
        ...
        if ($_POST['action'] === 'add') {
            ...
            // 2. Insert ke tabel pengeluaran_kas
            ...
            <div class="bg-white rounded-xl shadow-lg overflow-hidden">
                <div class="bg-gradient-to-r from-blue-500 to-blue-600 p-6">
                    <div class="flex justify-between items-center">
                        ...
                        <button onclick="showAddCostForm()" class="bg-white text-blue-600 hover:bg-blue-50 px-6 py-2 rounded-lg font-medium transition duration-200 flex items-center">
                                ...
                                <tbody class="divide-y divide-gray-200">
                                    <?php foreach ($costs as $cost): ?>
                                        <tr class="hover:bg-gray-50 transition duration-200">
                                            <td class="px-6 py-4 text-sm font-medium text-gray-900"><?php echo htmlspecialchars($cost['id_biaya']); ?></td>
                                            <td class="px-6 py-4 text-sm text-gray-900"><?php echo htmlspecialchars($cost['nama_biaya']); ?></td>
                                            <td class="px-6 py-4 text-sm text-gray-600"><?php echo htmlspecialchars(date('d M Y', strtotime($cost['tgl_biaya']))); ?></td>
                                            <td class="px-6 py-4 text-sm text-gray-900 font-medium"><?php echo formatCurrency($cost['total']); ?></td>
        ...
        <form method="POST" onsubmit="return validateForm(this)">
            ...
            <div class="space-y-4">
                <div>
                    ...
                    <input type="text" name="id_biaya" value="<?php echo generateId('BYA'); ?>" 
                ...
                <div>
                    ...
                    <input type="text" name="nama_biaya" required 
                ...
                <div>
                    ...
                    <input type="date" name="tgl_biaya" value="${today}" required 
                           class="w-full px-4 py-3 border border-gray-300 rounded-lg focus:outline-none focus:ring-2 focus:ring-blue-500">
                </div>
                <div>
...
document.addEventListener('DOMContentLoaded', (event) => {
    ...
    notifications.forEach(notification => {
        ...
        }, 5000); // Notifikasi untuk biaya ditampilkan lebih lama
    });
});
</script>
